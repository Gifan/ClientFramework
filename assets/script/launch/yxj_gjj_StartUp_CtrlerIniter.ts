...
export function initPlatformConfig(debugPf: number, customPf: number): { platform: Platform, sdkMgrConfig: Config.SdkMgrConfig } {
    ...
    switch (platform) {
        case Platform.WECHAT_GAME:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_WX;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_WX;
            GameConst.AppConst.ALD_SDK_ID = "";
            GameConst.AppConst.MTA_SDK_ID = "";
            GameConst.AppConst.MTA_SDK_EVENT_ID = "";
            shareC = new WxShareCtrler();
            videoC = new WxAdCtrler(_getWxDict());
            channelC = new WxChannelCtrler(GameConst.AppConst.BMS_APP_NAME.toLocaleLowerCase());
            pfToolsC = new WxPlatformToolsCtrler();
            break;
        case Platform.TOUTIAO:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_TOUTIAO;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_TOUTIAO;
            shareC = new ToutiaoShareCtrler();
            videoC = new ToutiaoAdCtrler(_getZjtdDict());
            channelC = new ToutiaoChannelCtrler(GameConst.AppConst.BMS_APP_NAME.toLocaleLowerCase());
        ...
        case Platform.BAIDU_GAME:
            ...
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_BD;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_BD;
            shareC = new WxShareCtrler();
        ...
        case Platform.QQ_MINI:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_QQ;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_QQ;
            shareC = new WxShareCtrler();
        ...
        case Platform.OPPO_GAME:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_OPPO;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_OPPO;
            shareC = new OppoShareCtrler();
            videoC = new OppoAdCtrler(_getOppoDict());
            channelC = new FakeChannelCtrler(GameConst.AppConst.BMS_APP_NAME.toLocaleLowerCase());
            pfToolsC = new OppoPlatformToolsCtrler();
            break;
        case Platform.NV_IPHONE:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_IOS;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_IOS;
        ...
        case Platform.NV_ANDROID_NORMAL:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_ANDROID;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_ANDROID;
        ...
        case Platform.NV_ANDROID_SIX_K_PLAY:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_ANDROID;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_ANDROID_SIX_K_PLAY;
            shareC = new AndroidShareCtrler();
            videoC = new AndroidAdCtrler(_getAndroidDict());
            channelC = new FakeChannelCtrler(GameConst.AppConst.BMS_APP_NAME.toLocaleLowerCase());
            pfToolsC = new AndroidPlatformToolsCtrler();
        ...
        case Platform.NV_ANDROID_WONDER_BOX:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_ANDROID;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_ANDROID_WONDER_BOX;
            shareC = new AndroidShareCtrler();
            videoC = new AndroidAdCtrler(_getAndroidDict());
            channelC = new FakeChannelCtrler(GameConst.AppConst.BMS_APP_NAME.toLocaleLowerCase());
            pfToolsC = new AndroidPlatformToolsCtrler();
        ...
        case Platform.H5_4399:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_H5_4399;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_H5_4399;
        ...
        case Platform.H5_QTT:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_H5_QTT;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_H5_QTT;
        ...
        case Platform.H5_MOLI:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_H5_MOLI;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_H5_MOLI;
            ...
            break;
        case Platform.H5_UC:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_H5_UC;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_H5_UC;
        ...
        case Platform.VIVO_GAME:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_VIVO;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_VIVO;
            ...
            break;
        case Platform.SINA:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_SINA;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_SINA;
        ...
        case Platform.H5_ZHANG_YU:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_H5_ZHANG_YU;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_H5_ZHANG_YU;
        ...
        case Platform.XIAOMI_GAME:
            GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_XIAO_MI;
            GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_XIAO_MI;
        ...
        default:
            switch (debugPf) {
                default:
                case CEPlatform.dev:
                    GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_DEV;
                    GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_DEV;
                    break;
                case CEPlatform.wx:
                    GameConst.AppConst.BMS_APP_NAME = ProjectConst.PlanfromConst.BMS_APP_NAME_WX;
                    GameConst.AppConst.BMS_VERSION = ProjectConst.PlanfromConst.BMS_VERSION_WX;
...
function _getWxDict() {
    ...
    let idDict = {};
    idDict["defaultv"] = vid;
    idDict[GameConst.VideoADType.TIPS_KEY] = vid;
    idDict[GameConst.BannerADType.LV_TIPS] = bid;
    idDict[GameConst.BannerADType.LV_END] = bid;
    idDict[GameConst.BannerADType.AUTO] = bid;
    idDict[GameConst.InsertADType.NOMAL] = iid;
    return idDict;
}
...
function _getAndroidDict() {
    ...
    idDict[GameConst.BannerADType.AUTO] = bid;
    idDict[GameConst.InsertADType.NOMAL] = iid;
    idDict[GameConst.SplashADType.NOMAL] = sid;
    return idDict;
}
//QQ配置
function _getQQDict() {
    ...
    idDict[GameConst.BannerADType.LV_END] = bid;
    idDict[GameConst.BannerADType.AUTO] = bid;
    idDict[GameConst.GameboxADType.NOMAL] = boxId;
    return idDict;
}
