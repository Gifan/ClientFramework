import { ProjectConst } from "./yxj_gjj_projectConst";

/** [项目常量] 记录项目常量(枚举,字符串,等), 以方便维护时统一修改. 
 * ( 注 : 修改后将数据同步到 yxj_gjj_const_API.d.ts 文件, 
 * 可用于编译时 Typescript 的智能提示, 为代码编写和维护带来便利 (该文件不会编译到项目). */
export namespace GameConst {

    export class AppConst {
        static readonly WX_APPID = ProjectConst.AppConst.WX_APPID;
        static readonly PROJECT_CODE = ProjectConst.AppConst.PROJECT_CODE;
        static BMS_APP_NAME: string;
