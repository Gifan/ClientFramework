``````````````/** [项目常量] 记录项目常量(枚举,字符串,等), 以方便维护时统一修改. 
 * ( 注 : API.d.ts 文件仅用于编译时 Typescript 的智能提示, 不会编译到项目, 
 * 数据修改后必须同步到 yxj_gjj_const.ts , 否则运行时会报空. ) */
declare module cst {

    export class AppConst {
        static readonly WX_APPID = "微信appid";
        static readonly PROJECT_CODE = "项目代号";
        static readonly BMS_APP_NAME = "BMS的app_name";
        static readonly BMS_VERSION = "BMS的版本号";

        static ALD_SDK_ID: string;
        static MTA_SDK_ID: string;
        static MTA_SDK_EVENT_ID: string;
    }
    ...
    export class PageName {
        ...
        static readonly LV_SELECT = "yxj_gjj_lvSelectPage";
    ...
    export class PanelName {
        ...
        static readonly LV_GUIDE = "sfq_cz_guidePanel";
    ...
    export class CommonEvent {
        ...
        static readonly CHECK_FIRST_PASS_COMPLETE = "CHECK_FIRST_PASS_COMPLETE";
    ...
    export class ResPath {
        ...
        /** 卡片图鉴大图, path + [文件名] */
        static readonly PLATE_BIG_CARD = "yxj_gjj_resource/image/bigCard/";
        /** 关卡答案图 */
        ...
        /** 关卡选择界面的选项icon */
        static readonly SELECT_ITEM = "yxj_gjj_resource/image/lvSelect/sfq/";

        /** 提示卡预设体 */
        static readonly TIPS_CARD_ITEM = "yxj_gjj_resource/prefabs/ui/item/yxj_cz_tipsCardItem";
        /** 关卡内成就卡片预设体 */
        static readonly ROOM_CARD_ITEM = "yxj_gjj_resource/prefabs/ui/item/roomCardItem";
        /** 侦探题的彩色书按钮预制体路径 */
        ...
        /** 关卡内姐姐弟弟预制体 */
        static readonly HUMAN_ROOT = "yxj_gjj_resource/prefabs/level_element/human_root";
        /** 关卡内姐姐弟弟过场动画预制体 */
        static readonly CG_ANIM_ROOT = "yxj_gjj_resource/prefabs/level_element/cg_anim_root";
